...
public final class Constants {
  ...
  public static class ArmConstants{
    ...
    public static final int kArmSubstation = 0; // Height for substation pickup
    public static final int kArmGroundPickup = 97520;//767054;// 34352;
...
public static final double kArmD = 0.0;
  ...
  public static class ElevatorConstants{
    ...
    public static final int kElevatorSubstation = 74019; // Height for substation
