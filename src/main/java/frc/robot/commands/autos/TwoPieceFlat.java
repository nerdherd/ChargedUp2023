...
public class TwoPieceFlat extends SequentialCommandGroup {
    public TwoPieceFlat(SwerveAutoBuilder autoBuilder, SwerveDrivetrain swerve, Arm arm, Elevator elevator, MotorClaw claw) {        
