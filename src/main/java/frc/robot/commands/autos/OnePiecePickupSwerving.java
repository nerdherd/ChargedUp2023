...
public class OnePiecePickupSwerving extends SequentialCommandGroup {
    public OnePiecePickupSwerving(SwerveAutoBuilder autoBuilder, SwerveDrivetrain swerve, Arm arm, Elevator elevator, MotorClaw claw) {        
