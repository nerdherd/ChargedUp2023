    ...
    Alliance alliance){
        ...
        Trajectory cubeToZoooom = TrajectoryGenerator.generateTrajectory(
            List.of(
                ...
                new Pose2d(0.8, 0.2, Rotation2d.fromDegrees(179.9)) // TODO: TUNE THIS TRAJECTORY FOR APRIL TAG
                // new Pose2d(0.6, 1.0, Rotation2d.fromDegrees(179.9))
            ),
            trajectoryConfig);

        Trajectory moveInDrop = TrajectoryGenerator.generateTrajectory( // TODO: TUNE THIS FOR MOVE FORWARD DROP
            List.of(
        ...
        SwerveControllerCommand moveInDropCommand = new SwerveControllerCommand(
            moveInDrop, swerveDrive::getPose, SwerveDriveConstants.kDriveKinematics, 
            trajectoryXController, trajectoryYController, trajectoryThetaController, swerveDrive::setModuleStates, swerveDrive);
        ...
        return Commands.race(
            ...
            //     claw.setPower(0),
                ...
                Commands.waitSeconds(1000) // TODO: DEBUG
